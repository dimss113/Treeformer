...
parser.add_argument('--data-dir', default='datasets/oil-palm-trees.v14i.voc/', help='data path')  
...
class Trainer(object):
    ...
    def setup(self):
        ...
        # Gunakan CPU sebagai perangkat
        self.device = torch.device("cpu")
        self.logger.info("using CPU as no GPU is available")
